...
class ScrollingLabel:
    ...
    Collision-free: uses bgr_surface and clip like other text."""
...
class BasicHandler:
    ...
    def init_for_meter(self, meter_name):
        ...
        # Positions and colors — playinfo.align preferred; playinfo.center is legacy
        ...
        # Ticker: optional single scrolling line (replace or coexist with artist/title/album)
        ...
        # Ticker: single scrolling line (direction from meters.txt; loop mode when ltr/rtl)
    ...
    def render(self, meta, now_ticks):
        ...
        # LAYER: Ticker (single scrolling line; loop with separator/end_spaces; collision-free like text)
        if self.ticker_scroller:
        ...
        # LAYER: Sample rate / format icon (icon / text / both via volumio_typeformat)
